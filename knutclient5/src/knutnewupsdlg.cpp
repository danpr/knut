...
KNutNewUpsDlg::KNutNewUpsDlg (KNutUpsData* const upsData, KNutVarData* const analogData, const bool add, QWidget* parent)
  : QDialog( parent ), addMember(add), m_myUpsData(upsData) {

  QDialogButtonBox *buttonBox = new QDialogButtonBox(QDialogButtonBox::Ok | QDialogButtonBox::Cancel | QDialogButtonBox::Help);
  connect(buttonBox, SIGNAL(accepted()), this, SLOT(slotButtonOK()));
  connect(buttonBox, SIGNAL(rejected()), this, SLOT(reject()));
  connect(buttonBox, SIGNAL(helpRequested()), this, SLOT(slotButtonHelp()));
  ...
  topDialogLayout->addWidget(page);
  ...
  m_lineEdit1 = new QLineEdit( hostBox );
  ...
  m_lineEdit2 = new QLineEdit( hostBox );
...
// Name of UPS
  ...
  m_lineEdit7 = new QLineEdit( hostBox);
  ...
  m_lineEdit3 = new QLineEdit( hostBox );
  ...
  m_lineEdit4 = new QLineEdit( hostBox );
  ...
  m_lineEdit5 = new QLineEdit( hostBox );
  m_lineEdit5->setText("");
  ...
  m_lineEdit6 = new QLineEdit( hostBox );
...
void KNutNewUpsDlg::slotButtonOK(void) {
  makeOk();
}


void KNutNewUpsDlg::slotButtonHelp(void) {
  KHelpClient::invokeHelp("knc-configuration","knutclient");    
}

#include "moc_knutnewupsdlg.cpp"
