...
qDebug("KNutMainWindow::KNutMainWindow");
...
//std::cout << "Minumum " << m_panelMeter->minimumWidth() << std::endl;
  ...
  //loads position
  KConfigGroup config( KSharedConfig::openConfig(), "MainWindow" );
...
void KNutMainWindow::initAction ( void ) {
  ...
  QAction *actPrintUPSVars = new QAction(QIcon::fromTheme("view-list-tree"),i18n("&Showing UPS variables and commands"),this); 
  ...
  QAction *actInstComms= new QAction(i18n("&Running instant commands"),this);
  actionCollection()->addAction("instcomms",actInstComms);
  connect ( actInstComms,SIGNAL(triggered(bool)), this,SLOT(slotInstComms()));

  QAction *actRWVars = new QAction(i18n("Setting R&W variables"),this);
  ...
  QAction *actRefreshConnection = new QAction (QIcon::fromTheme("view-refresh"),i18n("Reconnect"),this);
  actionCollection()->setDefaultShortcut(actRefreshConnection, Qt::Key_F5);
...
#include "moc_knutmainwindow.cpp"
