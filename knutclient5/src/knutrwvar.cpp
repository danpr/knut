...
KNutRWVar::KNutRWVar(QString* oldUserName, QString* oldPassword, const QString userName, const QString password, KNutNet* const upsNet, QWidget* parent) : QDialog(parent), m_upsNet(upsNet), m_oldUserName(oldUserName), m_oldPassword(oldPassword) {
  upsVarDef upsVar;
...
qDebug ("KNutRWVar::KNutRWVar");
  ...
  m_valueVarLine = new QLineEdit(mainWidget);
  m_valueVarLine->hide();
